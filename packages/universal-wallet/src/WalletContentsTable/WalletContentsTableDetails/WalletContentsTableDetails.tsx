...
import { LinkedDataPropertyTable } from '@material-did/common/dist/LinkedDataPropertyTable';

import { ContentCard } from '../../Cards/Content';
import { CurrencyCard } from '../../Cards/Currency';
import { PresentationCard } from '../../Cards/Presentation';
...
export const WalletContentsTableDetails: FC<IWalletContentsTableDetailsProps> = ({
  document,
}) => {
